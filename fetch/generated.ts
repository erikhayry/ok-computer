...
export const ViewerHomesDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'viewerHomes' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
...
} as unknown as DocumentNode<ViewerHomesQuery, ViewerHomesQueryVariables>
